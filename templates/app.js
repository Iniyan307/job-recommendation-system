...
const python = [
	{
		numb:6,
		question: "hi What is the state tree of North Carolina?",
		answer: "Dogwood",
    	option: [
			"Dogwood", 
			"Longleaf Pine", 
	...
	{
		numb:7,
		question: "What is the state tree of North Carolina? hi",
		answer: "Dogwood",
    	option: [
			"Dogwood", 
			"Longleaf Pine", 
	...
	{
		numb:8,
		question: " hii What is the state tree of North Carolina?",
		answer: "Dogwood",
    	option: [
			"Dogwood", 
			"Longleaf Pine", 
...
var java = [
	{
    	...
    	option: ["Dogwood", "Longleaf Pine", "Bald Cypress","Fraser Fir"],
    	answer: "Dogwood",
...
let questions = [
    ...
    {
        numb: 5,
        question: "What is the maximum value for an integer in Python 3?",
        answer: " No limit",
        options: [
                " 2^63-1",
                " 32767",
...
function quizQuestions(){
	var x=document.getElementById("ans1op2").checked
	// var formEl = document.forms.f1;
	// var formData = new FormData(formEl);
	// var jsonob=JSON.stringify(Object.fromEntries(formData));
	// jsonob.hasOwnProperty("java"))
	if(x==true){
		questions=questions.concat(python);
	}
}
